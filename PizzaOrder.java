...
public class PizzaOrder
{
   public static void main (String [] args)
   {
      ...
      switch (crustType) {
         case ( 'H' ):
         System.out.println("crust is Hand-tossed");
         break;
         case ( 'T'):
         System.out.println("crust is Thin-crust");
         break;
         case ( 'D'):
         System.out.println(" crust is Deep-dish");
         break;
      }
      if ( crustType != 'H'|| crustType != 'T'|| crustType != 'D'){
         System.out.println("input was not one of the choices");
         crust = "Hand-tossed";
      }
      ...
      if ( discount = true){
         System.out.println("bạn đủ điều kiện để giảm 2$");
         cost = cost - 2;
      }
